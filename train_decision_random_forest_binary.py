...
def main():
    ...
    if use_predictability and use_metric_values:
        df_test.to_csv('data/results/classifier/randomforest_results_both_binary.csv',index=False)
    elif use_predictability:
        df_test.to_csv('data/results/classifier/randomforest_results_predictability_binary.csv',index=False)
    elif use_metric_values:
        df_test.to_csv('data/results/classifier/randomforest_results_metric_values_binary.csv',index=False)
